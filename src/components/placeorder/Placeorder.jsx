...
// import placeorderman from "../../assets/images/footer/manorder.jpg";
...
//           <h2 className="order-title">Place your order <br /> now</h2>
...
//           <p className="order-subtitle">Get your cooking gas delivered to you in a giffy</p>
//         </div>
        
//         <div className="gas-cylinder-section">

//         </div>
//       </div>
//       <div className="order-card-man">
//       <div className="delivery-man-card">
//         <img src={placeorderman} alt="Delivery Man" className="delivery-man" />
//       </div>
//       </div>
//     </assets
// };
